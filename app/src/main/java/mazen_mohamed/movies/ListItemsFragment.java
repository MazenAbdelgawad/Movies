...
public class ListItemsFragment extends Fragment {
    ...
    private Menu menu;
    protected CardAdapter itemAdapter;
    protected RecyclerView.LayoutManager mLayoutManager;
    protected List<Card> dataSet;
    protected List<Card> favoriteDataset;
    ...
    {
        View view = inflater.inflate(R.layout.grid_cards, container, false);  //##Me Grid her not !!
        ButterKnife.bind(this, view);

        mRecyclerView.setHasFixedSize(true);
        itemAdapter = new CardAdapter(getActivity(),dataSet);
